...
function alterar(cpf){
    ...
    for(let i = 0; i < clientes.length; i++){
        ...
        if (cliente.cpf == cpf){
            ...
            document.getElementById("nomeDoPiriquito").value = cliente.nomeDoPiriquito
            document.getElementById("cpfDaMae").value = cliente.cpfDaMae
...
function salvar(){
    ...
    let nomeDoPiriquito = document.getElementById("nomeDoPiriquito").value
    let cpfDaMae = document.getElementById("telefone").value
    ...
    if (clienteAlterado == null){
        let cliente = {
            ...
            "cpf": cpf,
            "telefone": telefone,
            "nomeDoPiriquito": nomeDoPiriquito,
            "cpfDaMae": cpfDaMae
        }
        ...
        clienteAlterado.nomeDoPiriquito = nomeDoPiriquito
        clienteAlterado.cpfDaMae = cpfDaMae
    }
...
function exibirDados(){
    ...
    for(let i = 0; i < clientes.length; i++){
        ...
        <tr>
            ...
            <td>${clientes[i].nomeDoPiriquito}</td>
            <td>${clientes[i].cpfDaMae}</td>
            <td>
...
function limparForm(){
    ...
    document.getElementById("nomeDoPiriquito").value = ""
    document.getElementById("cpfDaMae").value = ""
}